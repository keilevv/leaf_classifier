...
function EditClassificationForm({ isOpen, closeModal, selectedUpload }) {
  ...
  return (
    <>
      {selectedUpload && (
        <div className="space-y-6 py-8 max-w-xl mx-auto">
          <img
          ...
          <h1 className="text-lg font-medium text-green-700">Change Tags</h1>
          <form
                ...
                <div className="relative mt-2">
                  <Combobox.Input
                    ...
                    displayValue={(val) => {
                      ...
                      return s ? `${s.scientificName} - ${s.commonNameEn}` : "";
                    }}
              ...
              <Combobox value={selectedShape} onChange={setSelectedShape}>
                <div className="relative mt-2">
                  <Combobox.Input
                    ...
                    displayValue={(val) => {
                      if (!val) return "";
                      const sh = shapes.find((s) => `${s.nameEn}` === `${val}`);
                      return sh ? sh.nameEn : "";
                    }}
